...
- [ ] **4. FastAPI backbone: CORS, endpoint stubs, rate limiting, .env**
...
- [ ] **5. Open Food Facts service + `/product/{barcode}` endpoint**
...
- [ ] **6. BarcodeScan.jsx — camera, html5-qrcode, loading + success + error states**
...
- [ ] **8. PriceScan.jsx — camera capture, OCR flow, confirmation card, manual entry**
...
- [ ] **9. SerpAPI service + `/verdict` endpoint + verdict logic**
...
- [ ] **10. VerdictScreen + VerdictTab — badge, suggestion bubbles, SCAN AGAIN**
